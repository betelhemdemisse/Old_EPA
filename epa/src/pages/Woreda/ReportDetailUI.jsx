...
export default function ReportDetailUI({
  ...
  const getExperts = async () => {
    try {
      const res = await reportService.getExpertsByWoredaHierarchyId();
      console.log("")
      setExperts(res);
    } catch {
      setToast({
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex -space-x-2">
                      {(
                        chat.participants ||
                        [chat.reported_by, chat.assigned_to].filter(Boolean)
                      ).map((user, idx) => (
                        <div
                          key={user.id || idx}
      ...
      <div className="flex justify-between items-center  px-6 ">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex gap-4">
            ...
            {permissions.includes("woreda:can-assign-to-expert") &&
           ...
           <div className="lg:col-span-2 space-y-8">
              ...
              <div className="rounded-2xl p-4 border border-gray-300">
                ...
                >
                  ...
                  {/* Chat Content */}
                  <div className="space-y-4">
                    {/* Feedback Form - Only show if expert */}
                    {activeChatTab === "feedback" && isExpert && (
                    ...
                    {/* Issue Raise Form - Only for experts AND NO case attachments */}
                    
                     {activeChatTab === "issue" && isExpert && !hasCaseAttachments && (
                      <div className="bg-white border border-gray-200 rounded-lg p-4">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">
                          Raise an Issue
                        </h3>
                    ...
                    {activeChatTab === "extension" && isExpert  && (
                      <div className="bg-white border border-gray-200 rounded-lg p-4">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">
